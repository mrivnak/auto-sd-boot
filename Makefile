install:
	...
	echo "python3 /usr/share/systemd-boot-populate/systemd-boot-populate.py" > $(DESTDIR)/usr/sbin/systemd-boot-populate
	chmod 700 $(DESTDIR)/usr/sbin/systemd-boot-populate
